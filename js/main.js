        ...
        if  (State.selectedBoxId !== null) {
            switch (e.code.toLowerCase()) {
                ...
                case "digit4":
                    ...
                    break
                case "digit5":
                    BoxService.changeLabel(State.selectedBoxId, "Payment_method")
                    break
                case "digit6":
                    BoxService.changeLabel(State.selectedBoxId, "Total_Amount")
                    break
                case "digit7":
                    BoxService.changeLabel(State.selectedBoxId, "Company_Name")
                    break
                case "digit8":
                    BoxService.changeLabel(State.selectedBoxId, "Address")
                    break
                case "digit9":
                    BoxService.changeLabel(State.selectedBoxId, "Date")
                    break
                case "digit0":
                    BoxService.changeLabel(State.selectedBoxId, "Phone_No")
                    break
                case "minus":
                    BoxService.changeLabel(State.selectedBoxId, "Person")
                    break
                default:
                    break
            }
