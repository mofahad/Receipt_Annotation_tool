...
const boxColors = {
    Company_Name: "rgb(170,0,0)",
    Address: "rgb(170,80,13)",
    Person: "rgb(170,153,21)",
    Total_Amount: "rgb(103,170,0)",
    Date: "rgb(29,170,5)",
    Label: "rgb(24,170,135)",
    Price: "rgb(36,124,170)",
    Item: "rgb(0,51,170)",
    Phone_No: "rgb(49,0,170)",
    Misc: "rgb(116,0,170)",
    Payment_method: "rgb(0,0,0)",
...
export default class BoxService {
    ...
    static handleMouseDown(event) {
        ...
        //We don't want to do anything while we are in merging mode
